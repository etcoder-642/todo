...
if (!("taskManager" in localStorage)) {
  ...
  creator.getProject.createTask(
    "Learn Coding",
    "Odin Project",
    "take the Odin Project Lessons daily",
    "daily",
    "12-06-2024 11:30:03",
    "Medium",
  );
  creator.getProject.createTask(
    "Learn Coding",
    "finish toDO app",
    "the todo App is a versatile web app that let's users to add tasks projects and manage their life decisions efficiently.",
    "One Time",
    "6-05-2024 11:30:03",
    "High",
  );
  creator.getProject.createTask(
    "Learn Coding",
    "do leet code question",
    "test my DSL skill and take some leet code questions to stregthen my coding muscles",
    "daily",
    "12-06-2024 11:30:03",
    "Low",
  );
